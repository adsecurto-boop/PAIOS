...
class Settings {
  ...
  static const defaultRequestTimeoutSeconds = 30;
  static const defaultAiTimeoutSeconds = 30;
  ...
  Settings({
    ...
    this.aiTimeoutSeconds = defaultAiTimeoutSeconds,
    this.deviceToken,
    this.deviceName = '',
    this.relayUrl = '',
    this.account = 'default',
    bool? onboardingCompleted,
  }) : onboardingCompleted = onboardingCompleted ?? Platform.environment.containsKey('FLUTTER_TEST');
...
class SettingsService {
  ...
  static const _keyRequestTimeout = 'request_timeout_seconds';
  static const _keyAiTimeout = 'ai_timeout_seconds';
  ...
  Settings read() => Settings(
        ...
        requestTimeoutSeconds: _prefs.getInt(_keyRequestTimeout) ??
            Settings.defaultRequestTimeoutSeconds,
        aiTimeoutSeconds:
            _prefs.getInt(_keyAiTimeout) ?? Settings.defaultAiTimeoutSeconds,
        ...
        onboardingCompleted: _prefs.getBool(_keyOnboardingCompleted) ??
  ...
  Future<void> write(Settings settings) async {
    ...
    await _prefs.setInt(_keyRequestTimeout, settings.requestTimeoutSeconds);
    await _prefs.setInt(_keyAiTimeout, settings.aiTimeoutSeconds);
    ...
    await _prefs.setBool(_keyOnboardingCompleted, settings.onboardingCompleted);
  }
