...
a = Analysis(
    ['C:\\Users\\GBSBHL1261\\Documents\\Playwright\\Project\\PAIOS\\updater\\paios_updater\\__main__.py'],
    pathex=['C:\\Users\\GBSBHL1261\\Documents\\Playwright\\Project\\PAIOS\\updater'],
    binaries=[],
    datas=[],
    hiddenimports=[],
    hookspath=[],
